									...
									<form class="form-horizontal" action="" method="post">
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<textarea class="form-control" id="kpr_lain" name="kpr_lain" placeholder="Keperluan Surat" rows="5"></textarea>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<textarea class="form-control" id="ket_surat" name="ket_surat" placeholder="Ex : Surat Pengunduran Diri Jadi Mahasiswa" rows="5"></textarea>
												</div>
											</div>
