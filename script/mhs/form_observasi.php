									...
									<form class="form-horizontal" action="" method="post">
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<input id="telp" name="telp" type="text" placeholder="No.Telepon" class="form-control">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<textarea class="form-control" id="tmp_observasi" name="tmp_observasi" placeholder="Nama Instansi Harus Jelas Ex: PT.Sejahtera Jaya Abadi, Kota Bandung" rows="5"></textarea>
												</div>
											</div>
