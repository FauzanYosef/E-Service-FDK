...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Form Pengajuan Surat Persiapan Praktek Profesi Mahasiswa (PPM)</h1>
			</div>
		</div><!--/.row-->
								...
								<div class="panel-body">
									<form class="form-horizontal" action="" method="post">
										<fieldset>
											...
											<div class="form-group">
												<label class="col-md-3 control-label" for="pem_studi">Pembimbing Studi</label>
												<div class="col-md-6">
													<input id="pem_studi" name="pem_studi" type="text" placeholder="Pembimbing Studi" class="form-control">
												</div>
											</div>
													  ...
													  <div class="modal-dialog">
													    ...
													    <div class="modal-content">
													      <div class="modal-header">
													        ...
													        <h4 class="modal-title">Detail Surat Praktik Profesi Mahasiswa</h4>
													      </div>
