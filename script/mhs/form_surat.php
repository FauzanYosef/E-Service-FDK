...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Form Pengajuan Surat Keterangan</h1>
			</div>
		</div><!--/.row-->
									...
									<form class="form-horizontal" action="" method="post">
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<textarea class="form-control" id="kpr_lain" name="kpr_lain" placeholder="Keperluan Surat Ex: beasiswa" rows="5"></textarea>
												</div>
											</div>
											...
											<!-- <div class="form-group">
												...
												<div class="col-md-6">
													<textarea class="form-control" id="ket_surat" name="ket_surat" placeholder="Ex : Surat Pengunduran Diri Jadi Mahasiswa (jika tidak ada kosongkan)" rows="5"></textarea>
												</div>
											</div> -->
